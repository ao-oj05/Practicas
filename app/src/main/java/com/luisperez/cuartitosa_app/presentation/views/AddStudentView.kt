...
fun AddStudentView(navController: NavController, dashboardViewModel: DashboardViewModel){
    ...
    Scaffold(
        ...
        AddStudentViewForm(it, dashboardViewModel, snackbarHostState, scope)
    }
}

@Composable
fun AddStudentViewForm(paddingValues: PaddingValues, dashboardViewModel: DashboardViewModel, snackbarHostState: SnackbarHostState, scope: CoroutineScope){
    ...
    Column(
        ...
        Text("Ingresa los datos del estudiante")
        ...
        Button(
            onClick = {
                ...
                dashboardViewModel.addStudent(name,description,image)
                name = ""
                description = ""
                image = ""
